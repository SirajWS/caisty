...
import { SupportRequestsEmptyState } from "./SupportRequestsEmptyState";
import { portalTableShell, portalTextLink } from "../../lib/portalUi";

function statusBadgeClass(status: string): string {
  if (status === "closed") return "support-status-badge support-status-badge--closed";
  if (status === "in_progress") return "support-status-badge support-status-badge--progress";
...
export function SupportRequestsList({
  ...
  return (
    <section className="dashboard-panel dashboard-panel--wide support-requests-panel">
