...
const POS_WINDOWS_URL =
  "https://www.caisty.com/downloads/Caisty.PoS_0.3.2_x64-setup.exe";
...
describe("getPosReleaseConfig", () => {
  ...
  it("derives version and file name from VITE_POS_WINDOWS_URL", () => {
    ...
    expect(release.latestVersion).toBe("0.3.2");
    expect(release.installer.fileName).toBe("Caisty.PoS_0.3.2_x64-setup.exe");
